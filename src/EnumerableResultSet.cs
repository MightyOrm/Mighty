...
namespace Mighty
{
    ...
    public sealed class EnumerableResultSet<T> : IEnumerable<T> where T : class, new()
    {
        ...
        /// <summary>
        /// Return the results in this result set as type <typeparamref name="T"/>, with current mappings etc.
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Return the results in this result set as type <typeparamref name="T"/>, with the potential to override mappings etc.
        /// </summary>
            ...
            DataProfiler profiler = null)
        {
            ...
            return mightyT.QueryNWithParams<T>(null, (CommandBehavior)(-1), _connection, _outerReader);
        }
