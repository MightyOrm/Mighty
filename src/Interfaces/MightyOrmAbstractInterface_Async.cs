...
namespace Mighty.Interfaces
{
    abstract public partial class MightyOrmAbstractInterface<T>
    {
        ...
        /// <returns></returns>
        abstract public Task<IAsyncEnumerable<T>> QueryAsync(
            DbCommand command,
        ...
        /// 'Easy-calling' version, optional args straight after SQL.
        /// </remarks>
        abstract public Task<T> SingleFromQueryAsync(
            string sql,
            params object[] args);
        ...
        /// <param name="args">Auto-numbered parameter values for SQL</param>
        /// <returns></returns>
        abstract public Task<IAsyncEnumerable<T>> QueryWithParamsAsync(
            string sql,
        ...
        /// <param name="args">Auto-numbered input parameters</param>
        /// <returns></returns>
        abstract public Task<T> SingleFromQueryWithParamsAsync(
            string sql,
            object inParams = null,
            object outParams = null,
            object ioParams = null,
        ...
        /// <param name="args">Auto-numbered input parameters</param>
        /// <returns></returns>
        abstract public Task<IAsyncEnumerable<T>> QueryFromProcedureAsync(
            string spName,
            object inParams = null,
            object outParams = null,
            object ioParams = null,
        ...
        /// <param name="args">Auto-numbered input parameters</param>
        /// <returns></returns>
        abstract public Task<T> SingleFromProcedureAsync(
            string spName,
            object inParams = null,
            object outParams = null,
            object ioParams = null,
        ...
        /// <param name="connection">Optional connection to use</param>
        /// <returns></returns>
        abstract public Task<IAsyncEnumerable<IAsyncEnumerable<T>>> QueryMultipleAsync(
            DbCommand command,
            DbConnection connection = null);
        ...
        /// <param name="args">Auto-numbered parameter values for SQL</param>
        /// <returns></returns>
        abstract public Task<IAsyncEnumerable<IAsyncEnumerable<T>>> QueryMultipleWithParamsAsync(
            string sql,
            object inParams = null,
            object outParams = null,
            object ioParams = null,
        ...
        /// <param name="args">Auto-numbered input parameters</param>
        /// <returns></returns>
        abstract public Task<IAsyncEnumerable<IAsyncEnumerable<T>>> QueryMultipleFromProcedureAsync(
            string spName,
            object inParams = null,
            object outParams = null,
            object ioParams = null,
        ...
        abstract public Task<int> ExecuteAsync(
            DbCommand command,
            DbConnection connection = null);
        ...
        abstract public Task<dynamic> ExecuteWithParamsAsync(
            string sql,
            object inParams = null,
            object outParams = null,
            object ioParams = null,
        ...
        /// <param name="args">Auto-numbered input parameters</param>
        /// <returns>A dynamic object containing the names and output values of all output, input-output and return parameters</returns>
        abstract public Task<dynamic> ExecuteProcedureAsync(
            string spName,
            object inParams = null,
            object outParams = null,
            object ioParams = null,
        ...
        /// <param name="connection">Optional connection to use</param>
        /// <returns></returns>
        abstract public Task<object> ScalarAsync(
            DbCommand command,
            DbConnection connection = null);
        ...
        /// <param name="args">Auto-numbered input parameters</param>
        /// <returns></returns>
        abstract public Task<object> ScalarWithParamsAsync(
            string sql,
            object inParams = null,
            object outParams = null,
            object ioParams = null,
        ...
        /// <param name="args">Auto-numbered input parameters</param>
        /// <returns></returns>
        abstract public Task<object> ScalarFromProcedureAsync(
            string spName,
            object inParams = null,
            object outParams = null,
            object ioParams = null,
        ...
        /// TO DO: Possibly Possibly cancel the above, it makes no sense from a UI pov!
        /// </remarks>
        abstract public Task<PagedResults<T>> PagedFromSelectWithParamsAsync(
            string tableNameOrJoinSpec,
            string orderBy,
            string columns = null,
            string where = null,
        ...
        /// <param name="args">Auto-numbered parameters for the SQL</param>
        /// <returns></returns>
        abstract protected Task<IAsyncEnumerable<X>> QueryNWithParamsAsync<X>(
            string sql,
            object inParams = null,
            object outParams = null,
            object ioParams = null,
        ...
        /// <returns></returns>
        abstract protected internal Task<IAsyncEnumerable<X>> QueryNWithParamsAsync<X>(
            DbCommand command,
            CancellationToken cancellationToken = default,
            CommandBehavior behavior = CommandBehavior.Default,
            DbConnection connection = null,
        ...
        /// <param name="args">Auto-numbered input parameters</param>
        /// <returns></returns>
        abstract public Task<object> AggregateAsync(
            string function,
            string columns,
            string where = null,
            DbConnection connection = null,
        ...
        /// <param name="args">Auto-numbered input parameters</param>
        /// <returns></returns>
        abstract public Task<object> AggregateWithParamsAsync(
            string function,
            string columns = "*",
            string where = null,
            object inParams = null,
        ...
        /// <param name="connection">Optional connection to use</param>
        /// <returns></returns>
        abstract public Task<T> SingleAsync(
            DbCommand command,
            DbConnection connection = null);
        ...
        /// <returns></returns>
        /// <remarks>
        /// <see cref="DbConnection"/> parameter coming early (not just before args) in this one case is really useful, as
        /// it avoids ambiguity between the `columns` and `orderBy` strings and any optional string params.
        /// </remarks>
        abstract public Task<T> SingleAsync(
            string where,
        ...
        /// <param name="args">Auto-numbered input parameters</param>
        /// <returns></returns>
        abstract public Task<T> SingleWithParamsAsync(
            string where,
            string orderBy = null,
            string columns = null,
            object inParams = null,
        ...
        /// (so we don't want the user to have to non-fluently re-type it, or else type null, every time).
        /// </remarks>
        abstract public Task<PagedResults<T>> PagedWithParamsAsync(
            string orderBy = null,
            string columns = null,
            string where = null,
            int pageSize = 20,
        ...
        abstract public Task<T> InsertAsync(
            object item,
            DbConnection connection = null);
        ...
        abstract public Task<int> DeleteAsync(
            params object[] items);
        ...
        /// <param name="whereParams">Value(s) to be mapped to the table's primary key(s), or object containing named value(s) to be mapped to the matching named column(s)</param>
        /// <param name="connection">Optional connection to use</param>
        abstract public Task<int> UpdateUsingAsync(
            object partialItem,
            object whereParams,
            DbConnection connection = null);
